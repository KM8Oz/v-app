    ...
    return (
        ...
        >
            ...
            <XlsxIcon
                onClick={() => {
                    let _date = new Date();
                    _date.setFullYear(Number(_Bons.List[0]?.DFacture.substring(2, 6)), Number(_Bons.List[0]?.DFacture.substring(0, 1)) - 1);
                    exportFacture({
                        ...
                        // `${_Bons.List[0]?.DFacture.substring(2,4)}/${_Bons.List[0]?.DFacture.substring(0,2)}/${"20"+_Bons.List[0]?.DFacture.substring(4,6)}`
                        dfacture: _date
                    })
                }}
                style={{
